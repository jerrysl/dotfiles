-- Below is copied from pkazmier because he made useful functions for opening mini.files
-- in the cwd, or current buffer's dir, etc.
...
M.bufdir = function()
  -- TODO: Do string filtering on nvim_buf_get_name to omit the filename at the end.
  -- If the buffer is a file that has not yet been saved to the filesystem, then the
  -- "path" returned is invalid.
