return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<C-M-P>", function() harpoon:list():prev() end, { desc = 'Harpoon [n]ext buffer' })
    vim.keymap.set("n", "<C-M-N>", function() harpoon:list():next() end, { desc = 'Harpooon [p]revious buffer' })
  end
}
