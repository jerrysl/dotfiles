...
-- pkazmier's def/dec pickers always threw some wildcard error before opening the picker.
...
-- map({"n"     }, L"ml",  C"Pick recall",                                        "Recall: pick mark from list") -- I wish I were smart enough to set this up myself
